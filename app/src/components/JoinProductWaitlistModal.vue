          ...
          >
            ...
            <div class="mb-6">
              ...
              <p class="text-gray-600">
                We'll notify you when <strong>{{ productTitle }}</strong> is back in stock.
              </p>
            </div>
            ...
            <div v-if="submitted" class="text-center py-8">
              ...
              <p class="text-gray-600 mb-6">
                We'll email you at <strong>{{ form.email }}</strong> when this product is back in stock.
              </p>
              <button
                @click="closeModal"
            ...
            <form v-else @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                >
                  <option v-for="n in 10" :key="n" :value="n">{{ n }} {{ n === 1 ? 'item' : 'items' }}</option>
                </select>
              </div>
  ...
  try {
    ...
    const { data, error: insertError } = await supabase
      ...
      .insert({
        ...
        quantity_requested: form.value.quantityRequested,
