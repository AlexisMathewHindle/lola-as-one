...
EMAIL_FROM="${EMAIL_FROM:-Lots of Lovely Art <hello@lotsoflovelyart.com>}"
WORKSHOP_CONFIRMATION_EMAIL_FROM="${WORKSHOP_CONFIRMATION_EMAIL_FROM:-Lots of Lovely Art <hello@lotsoflovelyart.com>}"
EMAIL_REPLY_TO="${EMAIL_REPLY_TO:-hello@lotsoflovelyart.com}"
